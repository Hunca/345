...
liam:
	g++ -Isfml/include -o app Mainliam.cpp Ball.cpp Physics.cpp MovementManager.cpp PlayerManager.cpp GameManager.cpp -Lsfml/lib -lsfml-graphics -lsfml-window -lsfml-system
dt:
